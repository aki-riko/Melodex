  ...
  questions: [
    {
      ...
      answer: [
        'Melodex 是一个自托管的 PWA 音乐工具:搜索国内多源歌曲、在线播放、管理歌单,并把需要长期保存的歌曲下载到服务器曲库。',
    ...
    {
      question: '下载到服务器和缓存到本机有什么区别?',
      answer: [
        '「下载到服务器」会让服务器把音频落盘到下载目录,并尽量写入标题、歌手、专辑、歌词和封面。保存后会出现在「服务器曲库」里,适合长期收藏和被其他媒体库扫描。',
        '「缓存到本机」只保存在当前浏览器/PWA 的 IndexedDB 里,用于离线播放,不会进入服务器曲库,也不会自动同步到其他设备。空间紧张时浏览器可能回收缓存,可以在「离线音乐」里请求持久保存。',
      ],
    },
    {
