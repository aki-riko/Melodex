...
import { hasParsedLyrics, parseLRC } from '../src/contexts/playerLyrics.mjs';
...
assert.equal(hasParsedLyrics(fragranceLines), true);
assert.equal(hasParsedLyrics([]), false, '空解析结果不能作为有效缓存');
