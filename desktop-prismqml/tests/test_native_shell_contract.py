...
class NativeShellContractTests(unittest.TestCase):
    ...
    def test_pages_reuse_published_prismqml_components(self) -> None:
        ...
        self.assertIn("opacity: 0.82", lyrics_window)
        ...
        self.assertIn("shadowColor: Qt.rgba(0, 0, 0, 0.50)", lyrics_window)
        self.assertIn("shadowBlur: 0.30", lyrics_window)
        self.assertIn("shadowVerticalOffset: 2", lyrics_window)
        self.assertEqual(1, lyrics_window.count("layer.effect: Fluent.Shadow"))
        self.assertEqual(1, lyrics_window.count("renderType: Text.NativeRendering"))
        self.assertNotIn("style: Text.Outline", lyrics_window)
        ...
        self.assertEqual(2, word_fill.count("renderType: Text.NativeRendering"))
